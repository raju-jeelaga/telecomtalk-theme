...
<div class="highlights-content-wrap">
    ...
    <div class="via-source">
    	...
    	<a rel="nofollow" target="_blank" href="#">View Source Link</a>
    </div>
    <div class="subs-sec">
    	<ul>
    		<li>
    			<!-- <a href="#"> -->
    				<!-- <form id="feedburner-subscribe" onsubmit="window.open('http://feedburner.google.com/fb/a/mailverify?uri=telecomtalk/CIeV', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true" target="popupwindow" method="post" action="https://web.archive.org/web/20160313060842/http://feedburner.google.com/fb/a/mailverify"> -->
    				<form id="feedburner-subscribe">
						...
						<input type="hidden" name="uri" value="telecomtalk/CIeV">
    		...
    		<li>
    			<a target="_blank" class="tele-chnl" href="#">Joined Here</a>
    		</li>
    		<li>
    			<a target="_blank" class="ytb-chnl" href="#">
    				<i class="fab fa-youtube"></i> Subsrcribe
    			</a>
    		</li>
    	</ul>
    </div>
